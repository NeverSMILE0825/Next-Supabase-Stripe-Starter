...
const titleMap = {
  login: 'Login to AI Twitter Banner Generator',
  signup: 'Join AI Twitter Banner Generator and start generating banners for free',
} as const;
  ...
  return (
    <section className='mt-16 flex w-full flex-col gap-16 rounded-lg bg-black p-10 px-4 text-center'>
      <div className='flex flex-col gap-4'>
        <Image src='/apollo logo.png' width={80} height={80} alt='Apollo logo' className='m-auto' />
